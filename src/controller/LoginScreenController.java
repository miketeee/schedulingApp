...
public class LoginScreenController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       userLocation.setText(zId);
        ...
        if(Locale.getDefault().getLanguage().equals("fr")){
        try {
            ResourceBundle rsb = ResourceBundle.getBundle("rb/Nat", 
                    Locale.getDefault());
            btnLogin.setText(rsb.getString("Login"));
            username.setPromptText(rsb.getString("Username"));
            password.setPromptText(rsb.getString("Password"));
